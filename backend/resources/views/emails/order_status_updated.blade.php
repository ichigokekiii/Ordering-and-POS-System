    ...
    <div style="max-width:640px; margin:0 auto;">
        <div style="overflow:hidden; border:1px solid #e5e7eb; border-radius:24px; background:#ffffff; box-shadow:0 12px 32px rgba(15, 23, 42, 0.08);">
            <div style="padding:28px 28px 22px; background:{{ $heroBackground }}; color:{{ $heroTextColor }};">
                ...
                <h1 style="margin:16px 0 8px; font-size:28px; line-height:1.2;">Status changed for Order {{ $orderId }}</h1>
                <p style="margin:0; font-size:14px; line-height:1.7; color:{{ $heroSubtextColor }};">
                    Hi {{ $userName }}, here is the latest update for your order.
                </p>
            </div>
            ...
            <div style="padding:28px;">
                    ...
                    <tr>
                        <td colspan="2" style="vertical-align:top;">
                            <div style="border:1px solid #e5e7eb; border-radius:18px; background:#f8fafc; padding:16px;">
                                ...
                                <p style="margin:0; font-size:16px; font-weight:700; color:#111827;">{{ $trackingNumber ?: 'Not available yet' }}</p>
                            </div>
                        </td>
                    </tr>
                </table>
                ...
                @if ($statusMeta['code'] === 'delivered')
                    <div style="margin-top:20px; border:1px solid #bbf7d0; border-radius:20px; background:#f0fdf4; padding:18px 20px;">
                        <p style="margin:0; font-size:14px; line-height:1.7; color:#166534;">
                            Your order has been marked as delivered. You may leave feedback from your account page whenever you are ready.
                        </p>
                    </div>
                @endif
            </div>
            ...
            <div style="padding:18px 28px 24px; border-top:1px solid #f1f5f9; text-align:center; font-size:12px; line-height:1.7; color:#94a3b8;">
                This is an automated update from Petal Express PH.
            </div>
        </div>
    </div>
</body>
